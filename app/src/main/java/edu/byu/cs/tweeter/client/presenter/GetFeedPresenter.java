...
public class GetFeedPresenter {
    public interface View {
        ...
        void displayMessage(String message);    // TODO empty
    ...
    private StatusService statusService;    // FIXME do I need this?
    ...
    public void executeUserTask(String userAlias) {
        GetUserTask getUserTask = new GetUserTask(Cache.getInstance().getCurrUserAuthToken(),
                userAlias, new UserService.GetUserHandler());   // fixme MOVE HANDLER FROM FeedHolder
