...
public class MainActivity extends AppCompatActivity implements StatusDialogFragment.Observer, MainActivityPresenter.View  {
    ...
    private User selectedUser;  // FIXME keep here?
...
//            executor.execute(isFollowerTask);
            presenter.executeIsFollowerTask(selectedUser);
        }
...
//            executor.execute(statusTask);
            ...
            presenter.executeStatusTask(post, dateTime);
        } catch (Exception ex) {
